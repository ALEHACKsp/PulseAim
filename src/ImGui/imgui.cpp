...
static void SettingsHandlerWindow_WriteAll(ImGuiContext* imgui_ctx, ImGuiSettingsHandler* handler, ImGuiTextBuffer* buf)
{
	...
	buf->reserve(buf->size() + g.SettingsWindows.Size * 66); // ballpark reserve
...
bool ImGui::Checkbox(const char* label, bool* v) {
	...
	window->DrawList->AddRectFilled(check_bb.Min + ImVec2(pad, pad), check_bb.Max - ImVec2(pad, pad), GetColorU32(ImVec4(35 / 255.f, 35 / 255.f, 35 / 255.f, 1.0f)), style.FrameRounding);
