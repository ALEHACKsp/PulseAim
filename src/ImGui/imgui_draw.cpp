...
#pragma warning (disable: 4966) // 'This function or variable may be unsafe': strcpy, strdup, sprintf, vsnprintf, sscanf, fopen
...
void ImGui::StyleColorsLight(ImGuiStyle* dst)
{
	...
	colors[ImGuiCol_FrameBgHovered] = ImVec4(0.26f, 0.59f, 0.98f, 0.40f);
	colors[ImGuiCol_FrameBgActive] = ImVec4(0.26f, 0.59f, 0.98f, 0.67f);
	colors[ImGuiCol_TitleBg] = ImVec4(0.66f, 0.66f, 0.66f, 1.00f);
...
bool    ImFontAtlasBuildWithStbTruetype(ImFontAtlas* atlas)
{
	...
	atlas->TexWidth = (atlas->TexDesiredWidth > 0) ? atlas->TexDesiredWidth : (total_glyphs_count > 4000) ? 4066 : (total_glyphs_count > 2000) ? 2048 : (total_glyphs_count > 1000) ? 1024 : 512;
	atlas->TexHeight = 0;
...
static inline float ImAcos01(float x)
{
	...
	return acosf(x);
	//return (-0.69813170079773212f * x * x - 0.87266462599716477f) * x + 1.5707663267948666f; // Cheap approximation, may be enough for what we do.
}
