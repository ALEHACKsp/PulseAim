...
namespace Offsets {
	...
	namespace FortniteGame {
		namespace FortPawn {
			...
			DWORD CurrentWeapon = 0x5C0;//0x588;
		}
		...
		namespace FortWeapon {
			...
			DWORD AmmoCount = 0x94C;
			DWORD LastFireAbilityTime = 0xAD0;
	...
	BOOLEAN Initialize() {
		...
		FortniteGame::FortWeapon::LastFireAbilityTime = 0xAD0;
		FortniteGame::FortWeapon::AmmoCount = 0x94C;
